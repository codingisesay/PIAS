              ...
              if($sc['CourseTypeId'] == 1){
                ...
                if($sc['BoundleCourseWith'] != ""){
                  ...
                  $output .= "<ul class='w3-ul w3-white w3-hover-shadow'>
                        ...
                        <a type='button' href='classlist.php?course_id=$course_id' class='w3-button w3-black w3-padding-large'>View</a>
                        </li>
                      </ul>";
                  $output .="</div>";
              }
