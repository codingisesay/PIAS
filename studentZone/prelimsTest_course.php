...
// $studentCourses = fetchStudentCourses(1);
// echo "<pre>";
      ...
      $output .= "<header class='w3-row-padding' style=''> </header>";
        ...
        if($stu > 0){
            foreach($studentCourses as $sc){
                ...
                if($sc['CourseTypeId'] == 3){

                  if($sc['BoundleCourseWith'] != ""){
                     $course_id = $sc['BoundleCourseWith'];
                  }elseif($sc['CourseId'] != "" ){
                  ...
                  $output .= "<ul class='w3-ul w3-white w3-hover-shadow'>
                        ...
                        <a type='button' href='../testSeries/course_tests.php?course_id=$course_id' class='w3-button w3-black w3-padding-large'>View</a>
                        </li>
                      </ul>";
                  $output .="</div>";
              }
