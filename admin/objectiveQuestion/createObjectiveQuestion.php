...
<div class="container-fluid">
  <form action="insertObjectiveQuestion.php" method="POST">
<table id="customers">
  <tr>
    <th colspan="3">Create Objective Question</th>
  ...
  <td >Option B</td>
    <td><div class="form-group">
    <textarea name="Content2" id="Content2" placeholder="Required, at least 4 characters"></textarea><br>
   </div></td>
  </tr>
  <tr>
  <td >Option C</td>
    <td><div class="form-group">
    <textarea name="Content3" id="Content3" placeholder="Required, at least 4 characters"></textarea><br>
</div></td>
  </tr>
  <tr>
  <td >Option D</td>
    <td><div class="form-group">
    <textarea name="Content4" id="Content4" placeholder="Required, at least 4 characters"></textarea><br>
      </div></td>
  </tr>
  <tr>
  ...
  <td>Explanation</td>
    <td><div class="form-group">
    <textarea name="Content5" id="Content5" placeholder="Required, at least 4 characters"></textarea><br>
</div></td>
  </tr>
