...
<body>
    ...
    $new = end($LectursOfBatch);
 

    $lectureHanout = fatchLectureHandout($new['LectureId']);
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="PrelimeQuestionLectureCourse.php?lecture=<?php echo $new['LectureId']; ?>&course=<?php echo $courseId; ?>">PRELIMS QUESTION</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="MainsQuestionLectureCourse.php?lecture=<?php echo $new['LectureId']; ?>&course=<?php echo $courseId; ?>">MAINS QUESTION</a>
        </li>
        ...
        <div class="my-container">
            <div class="row info">
                <div class="col-sm-12 col-lg-8">
                    <div>
                        <p>
                        <p><iframe width="750" height="500" src="<?php echo $new['VideoEmbedCode'];?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe></p>
                    ...
                    <div class="summary">
                        <h3><?php echo $new['SubjectLocalName'];?></h3>
                        <?php echo $new['Synopsis']; ?>
                    </div>
                </div>
