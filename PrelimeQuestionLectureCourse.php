...
<div class="wrapper">
  ...
  <div class="container-fluid">
    ...
    <p> <?php echo $LOQ['ObjQuestionText'];?></p>
    <p><b style="color:red;">Option A :</b> <?php echo $LOQ['Option_A'];?></p>
    <p><b style="color:red;">Option B :</b> <?php echo $LOQ['Option_B'];?></p>
    <p><b style="color:red;">Option C :</b> <?php echo $LOQ['Option_C'];?></p>
    <p><b style="color:red;">Option D :</b> <?php echo $LOQ['Option_D'];?></p>
    ...
    <div class="w3-panel w3-green w3-round-xlarge" id="expl<?php echo $i; ?>" style="display: none;">
        <h5>Correct Answer : Option <?php echo $LOQ['CorrectAnswer'];?></h5>
        <p><?php echo $LOQ['explanation'];?></p>
    </div>
